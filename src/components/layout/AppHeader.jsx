      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative" ref={accountMenuRef}>
          ...
          {accountOpen && <div className="absolute right-0 top-11 z-[80] w-56 overflow-hidden rounded-xl border border-[#E1E1E5] bg-white p-1.5 shadow-xl" role="menu">
            ...
            {user?.is_admin && <button className="flex w-full items-center rounded-lg border-0 bg-transparent px-3 py-2 text-left text-xs font-medium text-[#515154] hover:bg-[#F2F2F4]" role="menuitem" type="button" onClick={() => { setAccountOpen(false); navigate('/admin'); }}>Admin Dashboard</button>}
...
function CreditIcon() {
  return <svg className="h-3.5 w-3.5" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true"><circle cx="8" cy="8" r="5.5" /><path d="M8 4.75v6.5M5.75 8h4.5" /></svg>;
}
