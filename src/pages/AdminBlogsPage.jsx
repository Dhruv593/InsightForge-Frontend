...
export function AdminBlogsPage() {
  ...
  return <AdminShell><div className="mx-auto max-w-7xl"><header className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between"><div><p className="mb-2 text-xs font-semibold text-brand-600">Content management</p><h2 className="m-0 text-2xl font-semibold tracking-[-0.035em] sm:text-3xl">Blog posts</h2><p className="mb-0 mt-2 text-sm text-[#6E6E73]">Write, preview, and publish articles for the separate blog.</p></div><div className="grid grid-cols-2 gap-2 sm:flex"><Link className="inline-flex min-h-11 items-center justify-center rounded-lg border border-[#D2D2D7] bg-white px-3 text-xs font-semibold" to="/blog" target="_blank">View blog ↗</Link><button className="min-h-11 rounded-lg bg-brand-600 px-3 text-xs font-semibold text-white" type="button" onClick={newPost}>New post</button></div></header>
